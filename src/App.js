...
import { addToMemory, applyNumber, changeOperation, clearDisplay, mcButton, mrButton } from './../src/actions'
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton onClick={() => handleMrButton()} value={"MR"}/>
              <CalcButton onClick={() => handleMcButton()} value={"MC"}/>
            </div>
